...
void HAL_ADC_MspInit(ADC_HandleTypeDef* hadc)
{
  ...
  if(hadc->Instance==ADC1)
  {
    ...
    PA0-WKUP     ------> ADC1_IN0
    */
    GPIO_InitStruct.Pin = BSB_IN_Pin;
    GPIO_InitStruct.Mode = GPIO_MODE_ANALOG;
    GPIO_InitStruct.Pull = GPIO_NOPULL;
    HAL_GPIO_Init(BSB_IN_GPIO_Port, &GPIO_InitStruct);
  ...
  else if(hadc->Instance==ADC2)
  {
    ...
    PA1     ------> ADC2_IN1
    */
    GPIO_InitStruct.Pin = U_BATT_IN_Pin;
    GPIO_InitStruct.Mode = GPIO_MODE_ANALOG;
    GPIO_InitStruct.Pull = GPIO_NOPULL;
    HAL_GPIO_Init(U_BATT_IN_GPIO_Port, &GPIO_InitStruct);
...
void HAL_ADC_MspDeInit(ADC_HandleTypeDef* hadc)
{
  if(hadc->Instance==ADC1)
  {
    ...
    PA0-WKUP     ------> ADC1_IN0
    */
    HAL_GPIO_DeInit(BSB_IN_GPIO_Port, BSB_IN_Pin);
  ...
  else if(hadc->Instance==ADC2)
  {
    ...
    PA1     ------> ADC2_IN1
    */
    HAL_GPIO_DeInit(U_BATT_IN_GPIO_Port, U_BATT_IN_Pin);
...
void HAL_DAC_MspInit(DAC_HandleTypeDef* hdac)
{
  ...
  if(hdac->Instance==DAC)
  {
    ...
    PA4     ------> DAC_OUT1
    */
    GPIO_InitStruct.Pin = BSB_OUT_Pin;
    GPIO_InitStruct.Mode = GPIO_MODE_ANALOG;
    GPIO_InitStruct.Pull = GPIO_NOPULL;
    HAL_GPIO_Init(BSB_OUT_GPIO_Port, &GPIO_InitStruct);
...
void HAL_DAC_MspDeInit(DAC_HandleTypeDef* hdac)
{
  if(hdac->Instance==DAC)
  {
    ...
    PA4     ------> DAC_OUT1
    */
    HAL_GPIO_DeInit(BSB_OUT_GPIO_Port, BSB_OUT_Pin);
...
void HAL_TIM_MspPostInit(TIM_HandleTypeDef* htim)
{
  ...
  else if(htim->Instance==TIM2)
  {
    ...
    PA2     ------> TIM2_CH3
    */
    GPIO_InitStruct.Pin = BLIGHT_Pin;
    GPIO_InitStruct.Mode = GPIO_MODE_AF_PP;
    GPIO_InitStruct.Pull = GPIO_NOPULL;
    GPIO_InitStruct.Speed = GPIO_SPEED_FREQ_LOW;
    GPIO_InitStruct.Alternate = GPIO_AF1_TIM2;
    HAL_GPIO_Init(BLIGHT_GPIO_Port, &GPIO_InitStruct);
...
void HAL_UART_MspDeInit(UART_HandleTypeDef* huart)
{
  if(huart->Instance==UART4)
  {
    ...
    PC11     ------> UART4_RX
    */
    HAL_GPIO_DeInit(GPIOC, RF_TX_Pin|RF_RX_Pin);
